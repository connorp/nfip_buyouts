...
```{r first-stage-graph, echo=FALSE, fig.cap="Flood insurance adoption, driven by Biggert-Waters, separately for adapted and non-adapted homes. The key source of variation in my first stage.", fig.dim=c(7,3.5)}
...
stargazer(transprob_flood_dd, transprob_flood_es, type=ifelse(knitr::is_latex_output(), "latex", ifelse(knitr::is_html_output(),"html" , "text")), 
          ...
          notes = "\\parbox[t]{0.3\\textwidth}{Fixed effects: census tract x flood zone, observation year, home construction year. Clustering SEs by census tract.}",
...
```{r trans-prob, echo=FALSE, fig.cap="Graph of home sale probability over time, separately for adapted and nonadapted homes.", fig.dim=c(7,3.5)}
...
stargazer(transprob_reg_dd, transprob_reg_2, transprob_reg_3, transprob_reg_2_lead, 
          ...
          notes = "\\parbox[t]{0.8\\textwidth}{Fixed effects: census tract x flood zone, observation year, home construction year, adaptation status. Clustering SEs by census tract.}", font.size = "small")
```
