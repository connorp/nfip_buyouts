...
```{r panel-summary-stats, echo=FALSE}
...
colnames(sumstats) <- ""
# set.caption("(\#panel-summary-stats) Summary statistics of the analysis panel.")
...
stargazer(transprob_flood, type=ifelse(knitr::is_latex_output(), "latex", ifelse(knitr::is_html_output(),"html" , "text")), 
          ...
          notes = "\\parbox[t]{0.5\\textwidth}{Includes fixed effects for census tract x flood zone, observation year, and home construction year.}",
          notes.align = "l")
```
...
stargazer(OLS_transprob_reg_2, OLS_transprob_reg_3, OLS_transprob_reg_2_lead, OLS_transprob_reg_3_lead, 
          ...
          notes = "\\parbox[t]{0.5\\textwidth}{All regressions include fixed effects for census tract x flood zone and observation year, and standard errors are clustered at the census tract.}")
```
